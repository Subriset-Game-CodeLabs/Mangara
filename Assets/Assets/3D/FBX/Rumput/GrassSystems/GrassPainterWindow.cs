...
public class GrassPainterWindow : EditorWindow
{
    ...
    static void Init()
    {
        ...
        SO_GrassToolSettings m_toolSettings = (SO_GrassToolSettings)AssetDatabase.LoadAssetAtPath("Assets/GrassSystems/grassToolSettings.asset", typeof(SO_GrassToolSettings));
        if (m_toolSettings == null)
        {
            Debug.Log("creating new one");
            m_toolSettings = CreateInstance<SO_GrassToolSettings>();

            AssetDatabase.CreateAsset(m_toolSettings, "Assets/GrassSystems/grassToolSettings.asset");
    ...
    {
        // Jangan jalankan kode di bawah ini jika toolSettings masih kosong
    ...
    private void OnEnable()
    {
        ...
        {
            toolSettings = (SO_GrassToolSettings)UnityEditor.AssetDatabase.LoadAssetAtPath("Assets/Settings/grassToolSettings.asset", typeof(SO_GrassToolSettings));
        }
    }
